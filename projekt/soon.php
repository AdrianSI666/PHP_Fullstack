...
<nav class="navbar navbar-default bg-primary bg-gradient font-size-base">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href="soon.php" class="btn btn-default text-light fw-bold">Najbliższe wizyty</a>
...
<div class="d-flex justify-content-center m-3">
    <div>
        <h5>Nie masz umówionych wizyt</h5>
    </div>
</div>
<div class="d-flex justify-content-center">
    <a href="add.php" class="btn btn-outline-primary m-2">Umów wizytę</a>
    <span class="btn btn-default m-2" style="cursor: default;">lub</span>
    <a href="all.php" class="btn btn-outline-primary m-2">Zobacz historię wizyt</a>
</div>
        ';
    }
    else {
